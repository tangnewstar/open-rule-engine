 ...
 * @date 2025/2/27
 */
public class JaninoScriptExpression implements Expression {
    private String expression;
    private ScriptEvaluator compiledExpression;

    public JaninoScriptExpression() {
    }

    public JaninoScriptExpression(String expression) {
    ...
    public Object evaluate(RuleContext context) {
        try {
            ...
            throw new RuleEvaluationException("Janino表达式["+expression+"]执行失败，参数："+context.getParams(), e);
        }
    }
    ...
    private void compileExpression() {
        try {
            ...
            throw new RuleEvaluationException("Janino表达式编译失败: " + expression, e);
        }
    }
